...
# sudo ./build/FlowCount -l 0,2,4,6,8 -- -P -p 8 --rx="(3,0,2,0)(3,1,4,1)" --tx="(6,0)(8,1)"
...
for _ in range(50):
	p = subprocess.Popen(["./build/FlowCount", "-l", "1,2,4,6,8", "--", "-P", "-p", "8", '--rx="(3,0,2,0)(3,1,4,1)"', '--tx="(6,0)(8,1)"'])
	time.sleep(370)
